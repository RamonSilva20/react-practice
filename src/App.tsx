      ...
      <Router>
        ...
        <div className="hidden md:block mt-4">
          <div className="ml-10 flex items-baseline space-x-4">
            ...
            {modules.map(module => (
              <Link to={module.routeProps.path} onClick={() => setCurrentTab(module.name)} className={currentTab === module.name ? 'bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium' : 'text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium'}>{module.name}</Link>
            ))}
